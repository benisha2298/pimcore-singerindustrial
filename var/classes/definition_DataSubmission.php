 ...
 * - Color [rgbaColor]
 * - RegularPrice [quantityValue]
 * - SalePrice [quantityValue]
 * - NetPackQuantity [quantityValue]
 * - NetPackQuantityUnits [quantityValue]
 * - PartStatus [input]
 * - LeadTime [input]
 * - MinOrderQuantity [quantityValue]
 * - StockStatus [input]
 * - DimensionalImage [image]
 * - ThreeDCADModel [input]
 * - ProductBrochure [input]
 * - ProductCatalog [input]
 * - CompatibilityChart [input]
 ...
 * - Angleshape [input]
 * - Bodysize [input]
 * - CompatiblehoseInsideDiameter [input]
 * - Compatiblehoses [input]
 * - CompatibletubeOutsideDiameter [input]
 * - Conductivity [input]
 * - Connectionstyle [input]
 * - Construction [input]
 * - Constructionstyle [input]
 * - Couplingtype [input]
 * - Dashsize [input]
 * - Dropdimension [input]
 * - EndSize1 [input]
 ...
 * - Finishplating [input]
 * - Flowrate [input]
 * - Fluidcompatibility [input]
 * - Fluidloss [input]
 * - HexSize1 [input]
 * - HexSize2 [input]
 * - HexSize3 [input]
 * - Hosecutofffactor [input]
 * - Hosedashsize [input]
 * - Impulsecyclelife [input]
 * - Internalconnectiontype [input]
 * - Itemtype [input]
 * - Latchtype [input]
 * - Laylinestyle [input]
 * - Lengthconfiguration [input]
 * - Port_size [input]
 * - Safetylockingmechanism [input]
 * - Sealmaterial [input]
 * - Sealpartnumberifincluded [input]
 * - ThreadSize1 [input]
 * - ThreadSize2 [input]
 * - Threadsealant [input]
 * - Torque [input]
            ...
            array (
              ...
              Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
                ...
                array (
                  ...
                  Pimcore\Model\DataObject\ClassDefinition\Data\Textarea::__set_state(array(
                     ...
                     'title' => 'Product Description ( Long )',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
              ...
              Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
                ...
                array (
                  ...
                  4 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'AirInclusionmax',
                     'title' => 'Air Inclusion max',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  7 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'CompatiblehoseInsideDiameter',
                     'title' => 'Compatible hose Inside Diameter',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  8 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'Compatiblehoses',
                     'title' => 'Compatible hoses',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  9 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'CompatibletubeOutsideDiameter',
                     'title' => 'Compatible tube Outside Diameter',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  30 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'Hosecutofffactor',
                     'title' => 'Hose cut off factor',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  32 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'Impulsecyclelife',
                     'title' => 'Impulse cycle life',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     ...
                     'title' => 'Internal connection type',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  39 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'Safetylockingmechanism',
                     'title' => 'Safety locking mechanism',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
                  ...
                  41 => 
                  Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                     'name' => 'Sealpartnumberifincluded',
                     'title' => 'Seal part number if included',
                     'tooltip' => '',
                     'mandatory' => false,
                     'noteditable' => false,
                     'index' => false,
